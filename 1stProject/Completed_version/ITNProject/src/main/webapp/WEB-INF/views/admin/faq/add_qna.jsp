		...
		<div class="row">
           ...
           <div class="col-md-10 d-flex align-items-start" style="padding-left: 0; padding-right: 0;">
				<div style="background-color: white; height: 100%; flex-grow: 1; max-width: 100%; margin-left: 10vw;">
                    <h2 class="text-left mt-4 ms-3" style="padding-bottom: 2vh;">자주 묻는 질문 등록하기</h2>
                   <form action="<c:url value='/qna/add'/>" method="post" id="addForm" name="addForm">
					    ...
					    <div class="mb-3 ms-3" style="max-width: 30%;">
					        ...
					        <textarea class="form-control" id="contents" name="contents" placeholder="내용을 입력하세요" rows="4" required></textarea>
					    </div>
